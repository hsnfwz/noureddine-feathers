...
<div class="flex flex-col items-center gap-4">
  ...
  <div class="flex max-w-[500px] flex-col gap-4 break-words break-all">
    <p class="break-words break-all">OVERVIEW</p>
    <p class="break-words break-all">
      This website is operated by Noureddine Feathers. Throughout the site, the
      terms "we", "us" and "our" refer to Noureddine Feathers. Noureddine
    ...
    <p class="break-words break-all">
      ...
      ("Terms of Service", "Terms"), including those additional terms of service
      and policies referenced herein and/or available by hyperlink. These Terms
      of Service apply to all users of the site, including without limitation
    ...
    <p class="break-words break-all">SECTION 1 - ONLINE STORE TERMS</p>
    <p class="break-words break-all">
    ...
    <p class="break-words break-all">SECTION 2 - GENERAL CONDITIONS</p>
    <p class="break-words break-all">
    ...
    <p class="break-words break-all">SECTION 5 - PRODUCTS OR SERVICES</p>
    <p class="break-words break-all">
    ...
    <p class="break-words break-all">SECTION 7 - OPTIONAL TOOLS</p>
    <p class="break-words break-all">
    ...
    <p class="break-words break-all">SECTION 8 - THIRD-PARTY LINKS</p>
    <p class="break-words break-all">
    ...
    <p class="break-words break-all">SECTION 10 - PERSONAL INFORMATION</p>
    <p class="break-words break-all">
    ...
    <p class="break-words break-all">SECTION 12 - PROHIBITED USES</p>
    <p class="break-words break-all">
    ...
    <p class="break-words break-all">
      In no case shall Noureddine Feathers, our directors, officers, employees,
    ...
    <p class="break-words break-all">SECTION 14 - INDEMNIFICATION</p>
    <p class="break-words break-all">
    ...
    <p class="break-words break-all">SECTION 15 - SEVERABILITY</p>
    <p class="break-words break-all">
    ...
    <p class="break-words break-all">SECTION 16 - TERMINATION</p>
    <p class="break-words break-all">
    ...
    <p class="break-words break-all">SECTION 17 - ENTIRE AGREEMENT</p>
    <p class="break-words break-all">
    ...
    <p class="break-words break-all">SECTION 18 - GOVERNING LAW</p>
    <p class="break-words break-all">
    ...
    <p class="break-words break-all">SECTION 20 - CONTACT INFORMATION</p>
    <p class="break-words break-all">
    ...
    <div class="break-words break-all">
      <p class="break-words break-all">Noureddine Feathers</p>
      <p class="break-words break-all">info@nprofiles.com</p>
      <p class="break-words break-all">
      ...
      <p class="break-words break-all">76960 0503 BC0001</p>
      <!-- <p class="break-words break-all">[INSERT VAT NUMBER]</p> -->
    </div>
  </div>
</div>
